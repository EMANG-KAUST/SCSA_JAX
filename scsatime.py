...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  5 11:46:18 2023
...
if __name__ == "__main__":
    ...
    plt.plot(x, y_noise, label = "Noised Signal")
    plt.plot(x, yscsa_denoised, label = "Reconstructed Noised Signal")
    plt.title("Noised Potential")
    plt.tight_layout()
    plt.show()